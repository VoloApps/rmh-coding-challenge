...
export default function Appointments() {
    ...
    // todo: move graphql api request to a different file and can be generalized by having the request as a parameter
    ...
    return <div className="bg-white p-4 min-w-[20%]">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700">
            <ul className="flex justify-center -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                <li className="mr-2">
                    <a href="#" className="inline-flex w-[50%] text-sm items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group">Today's</a>
                </li>
                <li className="mr-2">
                    <a href="#" className="inline-flex w-[50%] text-sm items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group" aria-current="page">All</a>
                </li>
            </ul>
        </div>
